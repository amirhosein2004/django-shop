...
class Bucket:
	...
	def __init__(self):  # inint method connection to cloud
	...
	def download_object(self, key):
		with open(settings.AWS_LOCAL_STORAGE + key, 'wb') as f:
			self.conn.download_fileobj(settings.AWS_STORAGE_BUCKET_NAME, key, f)  # Download files saved in directory aws


bucket = Bucket()  # Creating an instance to avoid repetition
